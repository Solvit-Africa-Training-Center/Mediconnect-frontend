...
import { LayoutDashboard, PlusCircle, Stethoscope, Users, FileText, Settings, ChevronLeft, ChevronRight } from "lucide-react"
...
const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-full bg-gray-950/90  shadow-sm z-20 transition-all duration-300 ${
