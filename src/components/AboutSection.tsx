  ...
  return (
    <section className=" bg-background">
      <div className="flex flex-col h-fit text-center bg-background-blue items-center place-content-center">
        ...
        <button className="bg-background text-primary px-15 py-3 rounded flex items-center gap-2 mb-10">Get started</button>
      </div>
      <div className="flex flex-col bg-white">
        ...
        <div className=" text-center p-2 text-sm">
          <p>&copy; 2025 Mediconnect. All rights reserved. | Republic of Rwanda - Ministry of Health</p>
        </div>
    </section>
  )
}
